...
g.Re = /^[a-zA-Z_$][a-zA-Z0-9._$]*$/;
g.module = function(a) {
  if (!g.isString(a) || !a || -1 == a.search(g.Re)) {
...
g.module.get = function(a) {
  return g.module.yf(a);
};
g.module.yf = function() {
};
g.G = null;
g.Hf = function() {
  return null != g.G;
...
g.Mb && (g.C = {rb:{}, ma:{}, requires:{}, hd:{}, Na:{}, xa:{}}, g.Kc = function() {
  ...
  (g.global.eh || g.Xg)(a, c) && (g.C.Na[a] = !0);
}, g.Ld = !(g.global.atob || !g.global.document || !g.global.document.all), g.Df = function(a) {
  g.jb("", 'goog.retrieveAndExecModule_("' + a + '");') && (g.C.Na[a] = !0);
}, g.sb = [], g.bk = function(a, c) {
  ...
  try {
    ...
    g.G.Bc ? g.xc(e, d) : g.we && Object.seal && Object.seal(d);
    g.Qf[e] = d;
  } finally {
    g.G = c;
  }
  ...
  if (g.Kc()) {
    ...
    var e = g.Ld;
    void 0 === c ? e ? (e = " onreadystatechange='goog.onScriptLoad_(this, " + ++g.Qc + ")' ", d.write('<script type="text/javascript" src="' + a + '"' + e + ">\x3c/script>")) : g.Ob ? g.Ye(a) : g.Wg(a) : d.write('<script type="text/javascript">' + c + "\x3c/script>");
    return !0;
  }
  return !1;
}, g.Qc = 0, g.vj = function(a, c) {
  "complete" == a.readyState && g.Qc == c && g.Pf();
  return !0;
}, g.ck = function(a) {
  function c(a) {
...
}, g.sf(), g.global.fh || g.jb(g.Y + "deps.js"));
g.rj = function(a) {
  a = a.split("/");
...
g.bind = function(a, c, d) {
  Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf("native code") ? g.bind = g.af : g.bind = g.$e;
...
g.Ii = function(a, c) {
  var d = function(a) {
    ...
    return c.join("-");
  }, e = g.Ac ? "BY_WHOLE" == g.pf ? d : e : function(a) {
    return a;
  };
  return c ? a + "-" + e(c) : e(a);
};
...
g.P.ve = g.$;
g.P.nf = function(a, c) {
  if (g.P.ve && Object.seal instanceof Function) {
    if (c && c.prototype && c.prototype[g.Pe]) {
      return a;
    }
    var d = function() {
...
g.Pe = "goog_defineClass_legacy_unsealable";
...
chrome.cast.se = {AVAILABLE:"available", UNAVAILABLE:"unavailable"};
g.c("chrome.cast.ReceiverAvailability", chrome.cast.se);
chrome.cast.Ce = {CHROME:"chrome", IOS:"ios", ANDROID:"android"};
g.c("chrome.cast.SenderPlatform", chrome.cast.Ce);
...
chrome.cast.re = {CAST:"cast", STOP:"stop"};
g.c("chrome.cast.ReceiverAction", chrome.cast.re);
...
chrome.cast.Be = function(a) {
  this.platform = a;
  this.packageId = this.url = null;
};
g.c("chrome.cast.SenderApplication", chrome.cast.Be);
...
var l = {o:{sh:"LAUNCH", jc:"STOP", hc:"SET_VOLUME", Hd:"GET_STATUS", Gh:"RECEIVER_STATUS", Nh:"CONNECT", Oh:"CLOSE", oh:"GET_APP_AVAILABILITY", Td:"LOAD", Ud:"PAUSE", $d:"SEEK", Vd:"PLAY", Wb:"STOP_MEDIA", Ub:"MEDIA_GET_STATUS", Vb:"MEDIA_SET_VOLUME", Sd:"EDIT_TRACKS_INFO", Xd:"QUEUE_LOAD", Wd:"QUEUE_INSERT", Qa:"QUEUE_UPDATE", Yd:"QUEUE_REMOVE", Zd:"QUEUE_REORDER", ph:"INVALID_PLAYER_STATE", wh:"LOAD_FAILED", vh:"LOAD_CANCELLED", qh:"INVALID_REQUEST", Ra:"MEDIA_STATUS", th:"LAUNCH_ERROR", PING:"PING", 
Dh:"PONG"}, Ta:{}};
l.Ta[l.o.Wb] = l.o.jc;
l.Ta[l.o.Vb] = l.o.hc;
l.Ta[l.o.Ub] = l.o.Hd;
...
chrome.cast.media.ue = {PLAYBACK_START:"PLAYBACK_START", PLAYBACK_PAUSE:"PLAYBACK_PAUSE"};
g.c("chrome.cast.media.ResumeState", chrome.cast.media.ue);
...
chrome.cast.media.Ne = {TEXT:"TEXT", AUDIO:"AUDIO", VIDEO:"VIDEO"};
g.c("chrome.cast.media.TrackType", chrome.cast.media.Ne);
chrome.cast.media.Ke = {SUBTITLES:"SUBTITLES", CAPTIONS:"CAPTIONS", DESCRIPTIONS:"DESCRIPTIONS", CHAPTERS:"CHAPTERS", METADATA:"METADATA"};
g.c("chrome.cast.media.TextTrackType", chrome.cast.media.Ke);
chrome.cast.media.Ge = {NONE:"NONE", OUTLINE:"OUTLINE", DROP_SHADOW:"DROP_SHADOW", RAISED:"RAISED", DEPRESSED:"DEPRESSED"};
g.c("chrome.cast.media.TextTrackEdgeType", chrome.cast.media.Ge);
chrome.cast.media.Le = {NONE:"NONE", NORMAL:"NORMAL", ROUNDED_CORNERS:"ROUNDED_CORNERS"};
g.c("chrome.cast.media.TextTrackWindowType", chrome.cast.media.Le);
chrome.cast.media.He = {SANS_SERIF:"SANS_SERIF", MONOSPACED_SANS_SERIF:"MONOSPACED_SANS_SERIF", SERIF:"SERIF", MONOSPACED_SERIF:"MONOSPACED_SERIF", CASUAL:"CASUAL", CURSIVE:"CURSIVE", SMALL_CAPITALS:"SMALL_CAPITALS"};
g.c("chrome.cast.media.TextTrackFontGenericFamily", chrome.cast.media.He);
chrome.cast.media.Ie = {NORMAL:"NORMAL", BOLD:"BOLD", BOLD_ITALIC:"BOLD_ITALIC", ITALIC:"ITALIC"};
g.c("chrome.cast.media.TextTrackFontStyle", chrome.cast.media.Ie);
...
chrome.cast.media.Ae = function() {
  this.type = l.o.$d;
  this.customData = this.resumeState = this.currentTime = null;
};
g.c("chrome.cast.media.SeekRequest", chrome.cast.media.Ae);
chrome.cast.media.lc = function() {
  this.type = l.o.Wb;
  this.customData = null;
};
g.c("chrome.cast.media.StopRequest", chrome.cast.media.lc);
chrome.cast.media.Se = function(a) {
  this.type = l.o.Vb;
  this.volume = a;
  this.customData = null;
};
g.c("chrome.cast.media.VolumeRequest", chrome.cast.media.Se);
...
g.c("chrome.cast.media.TvShowMediaMetadata", chrome.cast.media.Oe);
...
g.c("chrome.cast.media.TextTrackStyle", chrome.cast.media.Je);
...
g.c("chrome.cast.SessionRequest", chrome.cast.De);
...
chrome.cast.te = function(a, c) {
  this.statusText = a;
  this.appImages = c;
  this.showStop = null;
};
g.c("chrome.cast.ReceiverDisplayStatus", chrome.cast.te);
...
g.Cc = {};
g.Cc.ge = {Cd:1, $g:2, TEXT:3, ah:4, mh:5, lh:6, Eh:7, gh:8, hh:9, jh:10, ih:11, Ch:12};
g.a = {};
g.a.Pa = !1;
g.a.Gd = !1;
g.a.Qe = {fe:"\u00a0"};
...
g.a.Gb = function(a) {
  return g.a.contains(a, "&") ? !g.a.Gd && "document" in g.global ? g.a.ed(a) : g.a.Rg(a) : a;
};
g.a.Xj = function(a, c) {
...
g.a.Sg = 2147483648 * Math.random() | 0;
g.a.yi = function() {
  return "goog_" + g.a.Sg++;
};
g.a.Sj = function(a) {
...
g.h.ra = function(a, c) {
  c.unshift(a);
  g.debug.Error.call(this, g.a.Mg.apply(null, c));
  c.shift();
};
...
g.h.$h = function() {
  for (var a in Object.prototype) {
    g.h.rf(a + " should not be enumerable in Object.prototype.");
  }
};
g.h.Hc = function(a) {
...
g.b.Vi = function(a, c, d) {
  g.hg(g.b.splice, a, d, 0).apply(null, c);
};
  ...
  for (var c = [], d = 0;d < arguments.length;d++) {
    ...
    if (g.isArray(e)) {
      for (var f = 0;f < e.length;f += 8192) {
        for (var h = g.b.vf.apply(null, g.b.slice(e, f, f + 8192)), k = 0;k < h.length;k++) {
          c.push(h[k]);
        }
      }
    } else {
...
g.object.Di = function(a, c, d) {
  return (c = g.object.uf(a, c, d)) && a[c];
};
...
g.object.of = function(a) {
  var c = arguments.length;
  if (1 == c && g.isArray(arguments[0])) {
    return g.object.of.apply(null, arguments[0]);
  }
  for (var d = {}, e = 0;e < c;e++) {
    d[arguments[e]] = !0;
  }
...
l.v.td = {Lh:l.v.aa("tp.connection"), Mh:l.v.aa("tp.heartbeat"), Fh:l.v.aa("receiver"), yh:l.v.aa("media"), zh:l.v.aa("media.universalRemote.optIn"), Ph:l.v.aa("webrtc")};
l.v.Fe = g.object.Pg(l.v.td);
l.v.Ef = function(a) {
  return l.v.Fe.hasOwnProperty(a);
};
l.u = {};
l.u.ni = function(a) {
...
l.u.df = function(a) {
  return !!a && g.s(a.sessionId) && g.isString(a.namespaceName) && l.v.Mf(a.namespaceName) && !l.v.Ef(a.namespaceName);
};
l.u.cf = function(a) {
...
l.u.ef = function(a) {
  return a ? !g.b.find(a, function(a) {
    return !((a.receiverType == chrome.cast.ta.CUSTOM || a.receiverType == chrome.cast.ta.DIAL) && g.s(a.friendlyName) && 0 == a.capabilities.length && g.Jf(a.volume));
  }) : !1;
};
l.u.vc = function(a) {
...
l.m = {Sb:"iframe_init_result", Fd:"fail_to_connect_to_extension", dh:"client_reconnect", ua:"v2_message", Ib:"app_message", pd:"client_init", Pd:"log_message", pe:"request_session", qe:"request_session_by_id", Nd:"leave_session", bh:"client_disconnect", xe:"set_custom_receivers", Kb:"custom_dial_launch_response", ye:"set_receiver_display_status", ie:"query_tab_broadcast_status", nh:"extension_ready", Yg:"api_iframe_ready", ne:"receiver_availability", me:"receiver_action", Xb:"new_session", mc:"update_session", 
xd:"disconnect_session", oe:"remove_session", Zg:"app_message_success", uh:"leave_session_success", Jh:"set_receiver_volume_success", Hh:"set_custom_receivers_success", ERROR:"error", sd:"custom_dial_launch_request", Ih:"set_receiver_display_status_success", Kh:"tab_broadcast_status"};
l.Bh = function() {
  this.type = l.o.Ra;
  this.requestId = null;
  this.status = [];
...
chrome.cast.ga.prototype.init = function() {
  window.addEventListener("message", this.Zf.bind(this), !1);
};
chrome.cast.ga.prototype.Hg = function(a) {
  this.nc = a;
};
chrome.cast.ga.prototype.Zf = function(a) {
  a.source != window && a.origin == this.oc && (a = a.data, a.type == l.m.Sb && (this.Gf = !a.message), this.nc(a));
};
chrome.cast.ga.prototype.Ab = function(a) {
  this.Gf && this.Cf.contentWindow.postMessage(a, this.oc);
};
l.A = function(a, c, d) {
  this.dd = a;
  this.cb = c;
...
l.H.Vg = function(a, c) {
  ...
  l.H.Bf(a.playerState, a.loadingItemId) ? (a.currentItemId = null, a.loadingItemId = null, a.preloadedItemId = null, a.items = null) : l.H.Ug(a, c);
};
l.H.Bf = function(a, c) {
...
l.H.Ug = function(a, c) {
  if (c.hasOwnProperty("items") && c.items) {
    for (var d = [], e = l.H.bf(a.items), f = c.items, h = 0;h < f.length;h++) {
      var k = f[h];
      if (!k.media) {
...
chrome.cast.N = function(a) {
  this.Vf = 1E3 * Math.floor(1E5 * Math.random());
  this.Ia = a;
  this.ca = {};
  this.va = !1;
  ...
  this.oa = new l.sa;
  this.Ja = [];
  this.Ka = new l.H(this.nj);
  this.Ec = !1;
};
b = chrome.cast.N.prototype;
b.init = function() {
  this.Ia.Hg(this.jg.bind(this));
};
b.zf = function() {
  return "a" + this.Vf++;
};
...
b.Tf = function(a) {
  switch(a.type) {
    ...
    ;
    case l.m.mc:
      a.message = this.lf(a.message);
      break;
    case l.m.ua:
      a = a.message, a.type == l.o.Ra && a.status && (a.status = a.status.map(this.jf.bind(this)));
  }
};
b.lf = function(a) {
  return this.Ka.kf(a);
...
b.Wc = function(a, c) {
  ...
  this.Ka.Dg(a, c) && (this.wa.zg(a + "#"), this.Ga.Vc(a), this.oa.get(a).forEach(function(a) {
    a(d);
  }), this.oa.Vc(a));
};
b.$f = function(a) {
  this.wf(a.sessionId, a.namespaceName).forEach(function(c) {
...
b.Bb = function(a, c, d) {
  this.O(d) && (a = a || [], l.u.ef(a) ? this.M(new l.F(l.m.xe, a), new l.A(c, d)) : d && d(new chrome.cast.Error(chrome.cast.K.INVALID_PARAMETER)));
};
b.fa = function(a, c, d, e) {
  this.O(e) && (l.u.gf(c) ? (c.sessionId = a, this.M(new l.F(l.m.ua, c, null, null, chrome.cast.timeout.fa), new l.A(d, e, chrome.cast.timeout.fa))) : e && e(new chrome.cast.Error(chrome.cast.K.INVALID_PARAMETER)));
};
b.la = function(a, c, d) {
...
b.Gg = function(a, c, d) {
  this.O(d) && (l.u.df(a) ? this.M(new l.F(l.m.Ib, a, null, null, chrome.cast.timeout.zb), new l.A(c, d, chrome.cast.timeout.zb)) : d && d(new chrome.cast.Error(chrome.cast.K.INVALID_PARAMETER)));
};
b.Yc = function() {
...
b.lb = function(a, c, d) {
  l.u.cf(a) ? this.ab ? d && d(this.ab) : this.B ? c && c() : (this.B = a, this.va ? (this.Yc(), c && c()) : (this.ba = new l.A(c, d, 6E3), this.ba.bd())) : d && d(new chrome.cast.Error(chrome.cast.K.INVALID_PARAMETER));
};
...
b.Cb = function(a, c, d) {
  this.O(d) && this.M(new l.F(l.m.ye, a), new l.A(c, d));
};
...
g.g(chrome.cast.j.prototype, "setReceiverVolumeLevel", chrome.cast.j.prototype.Jg);
chrome.cast.j.prototype.Ig = function(a, c, d) {
  a = new l.kc(new chrome.cast.Volume(null, a), this.receiver.volume);
  chrome.cast.i.fa(this.sessionId, a, c, d);
};
g.g(chrome.cast.j.prototype, "setReceiverMuted", chrome.cast.j.prototype.Ig);
...
chrome.cast.j.prototype.stop = function(a, c) {
  chrome.cast.i.Xc(new l.Ee(this.sessionId), a, c, chrome.cast.timeout.cd);
};
g.g(chrome.cast.j.prototype, "stop", chrome.cast.j.prototype.stop);
chrome.cast.j.prototype.sendMessage = function(a, c, d, e) {
  chrome.cast.i.Gg(new l.nd(this.sessionId, a, c), d, e);
};
g.g(chrome.cast.j.prototype, "sendMessage", chrome.cast.j.prototype.sendMessage);
chrome.cast.j.prototype.$a = function(a) {
  chrome.cast.i.We(this.sessionId, a);
};
g.g(chrome.cast.j.prototype, "addUpdateListener", chrome.cast.j.prototype.$a);
chrome.cast.j.prototype.wb = function(a) {
  chrome.cast.i.Eg(this.sessionId, a);
};
g.g(chrome.cast.j.prototype, "removeUpdateListener", chrome.cast.j.prototype.wb);
chrome.cast.j.prototype.Ve = function(a, c) {
  chrome.cast.i.Te(this.sessionId, a, c);
};
g.g(chrome.cast.j.prototype, "addMessageListener", chrome.cast.j.prototype.Ve);
chrome.cast.j.prototype.Cg = function(a, c) {
  chrome.cast.i.yg(this.sessionId, a, c);
};
g.g(chrome.cast.j.prototype, "removeMessageListener", chrome.cast.j.prototype.Cg);
...
chrome.cast.j.prototype.Nf = function(a, c, d) {
  a.sessionId = this.sessionId;
  chrome.cast.i.Zc(a, c, d);
};
g.g(chrome.cast.j.prototype, "loadMedia", chrome.cast.j.prototype.Nf);
...
chrome.cast.j.prototype.pg = function(a, c, d) {
  a.sessionId = this.sessionId;
  chrome.cast.i.Zc(a, c, d);
};
g.g(chrome.cast.j.prototype, "queueLoad", chrome.cast.j.prototype.pg);
chrome.cast.media.f.prototype.mg = function(a, c, d) {
  chrome.cast.i.w(this, a, c, d, chrome.cast.media.timeout.D);
};
g.g(chrome.cast.media.f.prototype, "queueInsertItems", chrome.cast.media.f.prototype.mg);
chrome.cast.media.f.prototype.kg = function(a, c, d) {
  chrome.cast.i.w(this, new chrome.cast.media.Ua([a]), c, d, chrome.cast.media.timeout.D);
};
g.g(chrome.cast.media.f.prototype, "queueAppendItem", chrome.cast.media.f.prototype.kg);
...
g.g(chrome.cast.media.f.prototype, "queueInsertAndPlayItem", chrome.cast.media.f.prototype.lg);
...
g.g(chrome.cast.media.f.prototype, "queueJumpToItem", chrome.cast.media.f.prototype.ng);
chrome.cast.media.f.prototype.og = function(a, c, d, e) {
  if (0 > this.Aa(a)) {
    chrome.cast.Z("itemId not found in the queue.");
  } else {
...
g.g(chrome.cast.media.f.prototype, "queueJumpToItemWithCurrentTime", chrome.cast.media.f.prototype.og);
...
chrome.cast.media.f.prototype.Ng = function(a) {
  return -1 < this.supportedMediaCommands.indexOf(a);
};
g.g(chrome.cast.media.f.prototype, "supportsCommand", chrome.cast.media.f.prototype.Ng);
chrome.cast.media.f.prototype.xf = function() {
...
g.g(chrome.cast.media.f.prototype, "getEstimatedTime", chrome.cast.media.f.prototype.xf);
chrome.cast.media.f.prototype.$a = function(a) {
  chrome.cast.i.Ue(this, a);
};
